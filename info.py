...
BOT_TOKEN = environ.get('BOT_TOKEN', '8463590894:AAGUParOx9syNfvwWmqcEP0q2YwoTZ4z87k')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1395730131 6525645241').split()]
USERNAME = environ.get('USERNAME', "@Sultan6shah")
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Testbot2:kaif1344@testbot2.rls8e3k.mongodb.net/?retryWrites=true&w=majority&appName=Testbot2")

DATABASE_NAME = environ.get('DATABASE_NAME', "testbot2")
...
START_IMG = environ.get('START_IMG', 'https://files.catbox.moe/jantbo.jpg')
